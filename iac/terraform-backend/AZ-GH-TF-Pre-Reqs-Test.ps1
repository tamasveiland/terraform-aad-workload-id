...
$resourceGroupName = "rg-terraform-backend-test"
$storageName = "tfbackendtestsa$randomInt"
$kvName = "tf-backend-test-kv$randomInt"
$appName="tf-test-github-SPN$randomInt"
$region = "westeurope"
